...
module.exports = function (fields, options) {
    ...
    return function (req, res, next) {
        ...
        var helpers = require('./helpers')(fields, translate, sharedTranslationsKey, res, this);
        var hoganTranslate = helpers.hoganTranslate;
        var hoganRender = helpers.hoganRender;
        var conditionalTranslate = helpers.conditionalTranslate;
        var getTranslationKey = helpers.getTranslationKey;
        var classNames = helpers.classNames;
        var classNameString = helpers.classNameString;

        var inputText = require('./input-text')(_.extend({ fields: fields }, helpers));
        ...
        function optionGroup(key, opts) {
            ...
            return {
                ...
                legend: hoganTranslate(legendValue),
        ...
        function checkbox(key, opts) {
            ...
            return _.extend(opts, {
                ...
                label: hoganTranslate(fieldLabel || 'fields.' + key + '.label'),
                selected: selected,
            ...
            'input-submit': {
                handler: function () {
                    return function (props) {
                        ...
                        var obj = {
                            value: hoganTranslate('buttons.' + value),
                            id: id
                        };
